...
let num1 = num1 > 1 && num1 < 10;
let num2 = num2 >= 1 && num2 <= 10;
...
//num1 includes values after 1 and before 10; excluding 1 and 10 vs num2 includes all values including 1 and 10
...
const myAnswerForExercise10 = "Italy";
...
//could be undefined or null, depending if my emptyVariable is missing a value or never had a value in the first place
...
// A + B * 2 + D + C / 2:
const myAnswerForExercise15 = "error";

// Exercise 16 What is the value of A * B
const myAnswerForExercise16 = "error";
